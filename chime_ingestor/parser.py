"""PDF parsing logic for Chime statements."""
import re
...
# Example: 1/31/2025 Transfer from Chime Savings Account Transfer $200.00 $200.00 1/31/2025
# Amount can be negative: -$40.00
...
def _parse_date(date_str: str) -> Optional[date]:
    ...
    Args:
        date_str: Date string like "1/31/2025"
...
def _parse_amount(amount_str: str) -> Optional[Decimal]:
    ...
    Args:
        amount_str: Amount string like "$14.92" or "-$200.00"
...
def _find_transaction_type(description: str, raw_type: str) -> str:
    ...
    Args:
        ...
        raw_type: Type string from the PDF

    Returns:
        Normalized transaction type
    """
    # Use the raw type if it's a known type
...
def _extract_transactions_from_text(
    ...
    Returns:
        List of parsed ChimeTransaction objects
    """
...
def parse_pdf(path: Path) -> list[ChimeTransaction]:
    ...
    Returns:
        List of ChimeTransaction objects extracted from the PDF
